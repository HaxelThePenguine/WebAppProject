...
function SeatLegend() {
  return (
    <div className="seat-legend">
      <span><i className="legend-swatch swatch-free" /> free</span>
      <span><i className="legend-swatch swatch-premium" /> premium</span>
      <span><i className="legend-swatch swatch-mine" /> mine</span>
      <span><i className="legend-swatch swatch-other" /> reserved</span>
    </div>
  );
}
