              ...
              <div className="reservation-card-body d-flex justify-content-between align-items-start flex-wrap">
                ...
                <div>
                  ...
                  <div className="reservation-seat-group d-flex flex-wrap gap-2">
                    {reservationSeats.map(seat => (
                      <div
                        key={seat.id}
                        className={`seat-button reservation-seat-tile ${seat.category === 'premium' ? 'seat-premium' : 'seat-mine'}`}
                      >
                ...
                <div className="d-flex gap-2 flex-wrap mt-2">
                  {!isEditing ? (
                    <>
                      <button
                        className={`seat-button ${isExpanded ? 'seat-mine' : 'seat-free'}`}
                      ...
                      <button
                        className="seat-button seat-premium"
                        style={{ width: 'auto', padding: '0.5rem 1.1rem', minHeight: 'unset' }}
                    ...
                    <>
                      <button
                        className="seat-button seat-added"
                        style={{ width: 'auto', padding: '0.5rem 1.1rem', minHeight: 'unset' }}
                      ...
                      <button
                        className="seat-button seat-reserved-other"
                        style={{ width: 'auto', padding: '0.5rem 1.1rem', minHeight: 'unset' }}
